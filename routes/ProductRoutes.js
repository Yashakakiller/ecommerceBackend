...
const { createProduct, getProductsByCategory, deleteProduct, allProducts, randomProduct, singleProduct, relatedProducts, searchProduct } = require("../controllers/ProductController");
